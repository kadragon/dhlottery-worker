...
func TestClientAggregateLedger(t *testing.T) {
	...
	s := c.AggregateLedger("20200101", parseTime(t, "2026-06-08T10:00:00+09:00"))
	if s.CumulativePurchase != 14000 || s.CumulativeWinning != 2001005000 {
		t.Errorf("AggregateLedger = %+v", s)
	}
}
